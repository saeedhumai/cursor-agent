...
async def main(non_interactive=False, auto_continue=False):
    ...
    try:
        ...
        print_system_message("This demo showcases the enhanced interactive agent's ability to handle complex, multi-step tasks.")
        ...
        if non_interactive:
            ...
            print_system_message("You'll be prompted after each step to continue, ask questions, or end the demo")
        ...
        if non_interactive:
            print_separator()
            print_system_message(f"Demo completed. Files will be kept for 30 seconds for inspection.")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--auto-continue", action="store_true", help="Continue automatically between steps")
