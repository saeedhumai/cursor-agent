...
""")
    ...
    print_system_message("The agent has successfully implemented the missing functions and created a test file.")
...
async def main(non_interactive=False):
    ...
    try:
        ...
        print_system_message("This demo showcases the Claude agent's ability to manipulate files and generate code.")
