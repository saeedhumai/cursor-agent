        ...
        if non_interactive and hasattr(demo_module, "main_non_interactive"):
            ...
            if non_interactive:
                ...
                if "non_interactive" in sig.parameters:
                    ...
                    print_system_message(f"Warning: {demo_name} does not support non-interactive mode")
    ...
    try:
        ...
        if demo_list:
            ...
            if non_interactive:
                ...
                print_system_message("Available demos: " + ", ".join(info["name"] for info in AVAILABLE_DEMOS.values()))
                return
